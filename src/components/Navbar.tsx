...
const Navbar = () => (
  <nav className="bg-secondary text-offwhite shadow-sm">
    <div className="max-w-6xl mx-auto px-4 py-3 flex justify-between items-center">
      ...
      <div className="space-x-4 text-sm md:text-base">
        ...
        <NavLink to="/areas-de-atuacao" className={linkClass}>Áreas</NavLink>
        <NavLink to="/orcamento" className={linkClass}>Orçamento</NavLink>
